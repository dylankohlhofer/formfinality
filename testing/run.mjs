...
if (options.mode === 'all') {
  for (const suite of ['coach-regressions', 'review-regressions', 'adversarial', 'architecture', 'audio-stalls', 'setup-prompt', 'diagnostics', 'worker-queue', 'reported-session', 'movement-evidence', 'evidence-parity', 'partial-visibility', 'body-tolerance', 'interface', 'summary', 'interaction', 'local-coach', 'local-command-listener', 'ai-review', 'review-workflow']) {
