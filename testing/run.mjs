...
if (options.mode === 'all') {
  for (const suite of ['coach-regressions', 'review-regressions', 'adversarial', 'architecture', 'audio-stalls', 'voice-audit', 'audio-source-review', 'setup-prompt', 'diagnostics', 'references', 'worker-queue', 'reported-session', 'movement-evidence', 'evidence-parity', 'partial-visibility', 'body-tolerance', 'interface', 'summary', 'interaction', 'local-coach', 'profile-goals', 'duo-sync', 'local-command-listener', 'ai-review', 'review-workflow', 'web-release', 'economics']) {
